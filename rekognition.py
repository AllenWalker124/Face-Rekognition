...
def actualizacionStatus(ruta_img1):
    ...
    if isPerson:
        ...
        msg_notificacion = 'Su rostro no se está identificando correctamente, por favor coloquelo de nuevo en el recuadro cuidando que sus facciones se distingan con \nclaridad (no lentes, no cubrebocas).'
